...
**算例**：单元 $[0,1]$，三个节点 $x_1=0$，$x_2=0.5$，$x_3=1$，函数值 $f(0)=1$，$f(0.5)=4$，$f(1)=9$。求中点 $x=0.25$ 处的插值。

**Step 1**：计算长度坐标

$x=0.25$ 处：$\lambda_1 = (1-0.25)/1 = 0.75$，$\lambda_2 = (0.25-0)/1 = 0.25$

**Step 2**：计算三个形函数值

$N_1 = 2\lambda_1(\lambda_1-0.5) = 2\times 0.75\times 0.25 = 0.375$

$N_2 = 2\lambda_2(\lambda_2-0.5) = 2\times 0.25\times(-0.25) = -0.125$

$N_3 = 4\lambda_1\lambda_2 = 4\times 0.75\times 0.25 = 0.75$

验证：$N_1+N_2+N_3 = 0.375-0.125+0.75 = 1$ ✓

**Step 3**：插值

$f(0.25) = 1\times 0.375 + 9\times(-0.125) + 4\times 0.75 = 0.375 - 1.125 + 3 = 2.25$

精确值 $f(x)=x^2$ 时 $f(0.25)=0.0625$，但这里 $f$ 不是 $x^2$，所以插值结果就是 2.25。
