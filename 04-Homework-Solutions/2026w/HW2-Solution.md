...
> 📖 [1-3 §3.5.1 含高阶导数的泛函](../../01-Lecture-Notes/1-3-Variational-Methods.md#351-含高阶导数的泛函)
>
...
> 📖 [1-3 §3.4.9 条件极值与 Lagrange 乘子法](../../01-Lecture-Notes/1-3-Variational-Methods.md#349-条件极值与-lagrange-乘子法)
>
> 把约束条件用乘子 λ 引入目标函数，转化为无条件极值问题。后续在有限元中也常用于处理不可压缩约束等。
